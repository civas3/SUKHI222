...
<html lang="en">
    ...
    <body>
        ...
        <div class="hero-image">
            ...
            <div class="bg-image">
                <img
                    src="<?php echo cdnURL ?>/images/coming-soon.jpg"
                    title="Photo by: Gratisography-53H"
                    alt="Comin soon clock">
                <!--<video class="bg-video__content" autoplay muted loop> <source src="<?php
                echo cdnURL ?>images/videos/background-video.mp4" type="video/mp4" width="100%">
                Your browser is not supported! </video> -->
            </div>
            <!-- <div class="main-wrapper"> <div class="main-header"> </div> <div
            class="wrapper-content"> </div> </div> -->
