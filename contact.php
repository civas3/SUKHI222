...
<?php include("includes/site-settings/phpMailer.php");?>
<!DOCTYPE html>
...
<head>
    ...
    <?php include("includes/site-pages-meta/meta-contact.php");?>

    <?php include("includes/site-features/reCaptchaV3.php");?>
...
<body>
    ...
    <header id="header">
        ...
        <div class="header-content">
            <div class="header-content__image">
                <div class="header-image contact-header-bg"></div>
            </div>
    ...
    <main id="contact-us">
        <div class="container">
                    ...
                    <div class="col-12">
                        <div class="section-content">
                            ...
                            <div class="section-content__info">
                                <div class="section-content__info--contact-form">

                                    <form id="contactForm" method="post" enctype="multipart/form-data">
                                        <input type="hidden" id="g-token" name="g-token" />

                                        <!-- name -->
                                        <label style="margin-top: 0;" for="name">Full name</label>
                                        ...
                                        <select id="subject" name="subject">
                                            ...
                                            <option value="CV">Sending my CV / Resume</option>
                                        ...
                                        <input type="file" id="attachment-file" name="file" accept=".doc,.docx,.pdf">
                                        ...
                                        <!--  send button-->
                                        <input type="submit" id="send-button" class="btn-send-message" value="submit" name="submit" />
                                    </form>

                                    <?php include 'includes/site-features/reCaptchaV3_js.php';?>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <!--ASIDE fountation offices-->
            <aside>
                <div class="row">
                    <div class="col-12">
                        <div class="section-content">
                            <div class="section-content__header">
                                <h2>FOUNDATION OFFICES:</h2>
                                <div class="gold-border"></div>
                            </div>
                            <div class="section-content__info">
                                <div class="accordion">
                                    ...
                                    <div class="accordion-panel show">
                                        <div class="accordion-panel__info">
                                            <div class="foundation-offices">
                                                <ul>
                                                    <li><strong>Address:</strong></li>
                                                    <li>
                                                        <address>3813 Deleon St,</address>
                                                    </li>
                                                    <li>
                                                        <address>33609 Tampa, Florida, USA</address>
                                                    </li>
                                                    </br>
                                                    <li><strong>Email:</strong></li>
                                                    <li><a href="mailto:info@sukhi222.org">info@sukhi222.org</a></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="accordion-panel__info">
                                            <div class="foundation-offices">
                                                <ul>
                                                    <li><strong>Address:</strong></li>
                                                    <li>
                                                        <address>Avisha Way Greenvale 3059,</address>
                                                    </li>
                                                    <li>
                                                        <address>Victoria, Australia</address>
                                                    </li>
                                                    </br>
                                                    <li><strong>Email:</strong></li>
                                                    <li><a
                                                            href="mailto:info@sukhi222australia.org">info@sukhi222australia.org</a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
    ...
    <?php include 'includes/site-settings/phpMailerRedirect.php'; ?>
    ...
    <!-- JavScript Contact form validation -->
    <script src="<?php echo cdnURL ?>js/contact-form-validation.js"></script>
