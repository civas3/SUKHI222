...
<head>
    ...
    <title>SUKHI 222 | CONTACT US</title>
...
<body>
    ...
    <div class="hero-image">
        <div class="bg-image">
            <div class="header-image contact-image"></div>
        </div>
    ...
    <div class="main-wrapper">
        <div class="wrapper-content contact-form">
            <div class="contact-form__item">
                <div class="offices-details">
                    ...
                    <ul>
                        ...
                        <li>33609 Tampa, Florida, USA</li>
                        <li></li>
                        <li>
                            <a href="mailto:info@sukhi222.org">info@sukhi222.org</a>
                        </li>
                    </ul>
                    <ul>
                        <li style="padding-bottom: 3px;">
                        ...
                        <li>Avisha Way Greenvale 3059,</li>
                        <li>Victoria, Australia</li>
                        <li></li>
                        <li>
                            <a href="mailto:info@sukhi222australia.org">info@sukhi222australia.org</a>
                        </li>
                    </ul>
                </div>
